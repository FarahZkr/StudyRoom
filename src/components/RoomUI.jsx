...
function RoomUI({ onLeave }) {
  ...
  const sendMessage = () => {
    ...
    console.log("Sending message:", input, "at", time);
    const msg = { sender: localParticipant.identity, text: input, time: time };
    ...
    <div className="room">
          ...
          <div className="chat-messages">
            {messages.map((msg, i) => (
              <div key={i} className="msg-container">
                <div className="msg-sender">{msg.sender} <span>{msg.time}</span></div>
      ...
      <div className="controls">
        <div className="controls-container">
          ...
          >
            <svg
              className={isCameraEnabled ? "" : "disable"}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
            >
